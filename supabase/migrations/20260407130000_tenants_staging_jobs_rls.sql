-- Security Advisor: enable RLS on public.tenants and public.staging_jobs.
-- Requires public.current_user_tenant_id() (see fix_users_rls_recursion / prior migrations).

-- -----------------------------------------------------------------------------
-- public.tenants — members read/update their tenant only; bootstrap uses service_role
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- public.staging_jobs — enable RLS; tenant-scoped policies if tenant_id exists
-- -----------------------------------------------------------------------------
